...
import type { AnalysisResult, DisputeGuide, UserInsuranceInput } from "../types";
...
const ANALYSIS_SCHEMA: Schema = {
  ...
  properties: {
    ...
    locale: {
      type: Type.STRING,
      description: "Inferred country/locale based on address/currency (e.g., Pakistan, USA).",
    },
    ...
    insurance: {
      ...
      properties: {
        detectedProvider: {
          type: Type.STRING,
          description: "Name of insurance provider if found (e.g., State Life, Jubilee, Sehat Sahulat).",
        },
    ...
    verificationMethodology: {
      ...
      description:
        "List of steps or sources used to verify the charges (e.g. 'Checked against CPT code 99213', 'Verified Sehat Sahulat coverage limits').",
    },
    issues: {
      type: Type.ARRAY,
      items: {
        ...
        properties: {
          ...
          estimatedOvercharge: {
            type: Type.NUMBER,
            description: "Estimated amount of the overcharge in the detected currency.",
          },
          category: {
            type: Type.STRING,
            enum: ["Duplicate", "Upcoding", "Unbundling", "Inflation", "Insurance Error", "Other"],
          },
